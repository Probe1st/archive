...
function linkChanger(namePage) {
    let link = document.querySelector(`nav > a[href='${namePage}.html']`)
...
titleChanger(document.querySelector(".cont > div").getAttribute("data-title"));

linkChanger(document.querySelector(".cont > div").getAttribute("id"));